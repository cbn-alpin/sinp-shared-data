...
CREATE TABLE gn_imports.:occtaxImportTable AS
    SELECT
        ...
        "precision",
        tro.additional_fields AS additional_fields_releve,
        unique_id_occurrence,
        ...
        too.additional_fields AS additional_fields_occurence,
        unique_id_counting,
        ...
        count_min,
        count_max,
        cco.additional_fields AS additional_fields_counting,
